<template>
  <ReadingPassage>
    ...
    <p>
      ...
      a <a id="text-ref">scarlet-liveried</a> footman that morning, ran as
      follows:
    </p>

    <p>
      "If you have nothing better to do, Count (or Prince), and if the prospect
      of spending an evening with a poor invalid is not too terrible, I shall be
      very charmed to see you tonight between 7 and 10--Annette Scherer."
    </p>
    ...
    <p>
      ...
      gentle, patronizing intonation natural to a man of importance who had
      grown old in society and at court. He went up to Anna Pavlovna, kissed her
      hand, presenting to her his bald, scented, and shining head, and
      complacently seated himself on the sofa.
    </p>

    <p>
      "First of all, dear friend, tell me how you are. Set your friend's mind at
    ...
    <p>
      ...
      in an appearance there," said the prince. "My daughter is coming for me to
      take me there."
    </p>
  </ReadingPassage>
  <hr />
